...
const Home = () => {
  ...
  const homeProductCartListTragedy = productData.filter((el) => el.category === "Tragedy",[])
  ...
  return (
    <div className="p-2 md:p-4">
      ...
      <h2 className="font-bold text-2xl text-slate-800 mb-4">New Books</h2>
      ...
      {
            homeProductCartListTragedy[0] ? homeProductCartListTragedy.map(el => {
              return (
                <CardFeature
                  key={el._id}
                  id={el._id}
