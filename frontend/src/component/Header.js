        ...
        <div className='flex items-center h-full justify-between'>
                ...
                <div className='flex items-center gap-4 mb:gap-7'>
                    <nav className='gap-4 md:gap-6 text-base md:text-lg hidden md:flex'>
                        <Link to={""}>Home</Link>
                        <Link to={"menu/647371cb592b9c462807e876"}>Menu</Link>
                        <Link to={"about"}>About</Link>
                        <Link to={"contact"}>Contact</Link>
                    </nav>
                    <div className='text-2xl text-slate-600 relative'>
                        <Link to={"cart"}><BsCartFill/>
                        <div className='absolute -top-1 -right-1 text-white bg-red-500 h-4 w-4 rounded-full m-0 p-0 text-sm text-center'>{cartItemNumber.length}</div></Link> 
                    </div>
...
<Link to={"login"} className="whitespace-nowrap cursor-pointer px-2">Login</Link>
            ...
            <nav className='text-base md:text-lg flex flex-col md:hidden'>
                ...
                <Link to={"menu/647371cb592b9c462807e876"} className="px-2 py-1">Menu</Link>
